...
export class AzureBlobStorageProvider implements StorageProviderInterface {
  ...
  async uploadFile(_params: UploadFileParams): Promise<UploadFileResult> {
    throw new Error("AzureBlobStorageProvider: not yet implemented.");
  }
  ...
  async testConnection(): Promise<TestConnectionResult> {
    return {
      ok: false,
      message: "Azure Blob provider is registered but not yet implemented. Full support coming in a future phase.",
