...
type DetailData = {
  ...
  amcTemplate?: { title?: string; name?: string; approval_levels?: number } | null;
...
export default function AmcMyTasksPage() {
  ...
  const fetchTasks = useCallback(() => {
    setLoading(true);
    setError("");
    fetch("/api/amc/my-tasks", { credentials: "include" })
      .then((r) => r.json())
      .then((d) => {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-slate-900">My AMC Tasks</h1>
